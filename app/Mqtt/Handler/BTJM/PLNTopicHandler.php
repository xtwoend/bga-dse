...
class PLNTopicHandler implements MqttHandlerInterface
{
    ...
    {
        $tag = Str::snake(str_replace('-', '_', strtolower(str_replace('data/bga/btjm/dse/pln/', '', $topic))));
