...
namespace App\Mqtt\Handler\BTJM;
...
class Genset1TopicHandler implements MqttHandlerInterface
{
    ...
    {
        $tag = Str::snake(str_replace('-', '_', strtolower(str_replace('data/bga/btjm/dse/genset1/', '', $topic))));
